...
Webhooks are not necessary or beneficial in most form use cases, where officers are following up over email or Excel spreadsheet, since FormSG already outputs responses in those formats. Because of the IT expertise and ongoing support needed, they generally only make sense when responses are high-volume and integration with internal IT workflows will be highly valuable.
